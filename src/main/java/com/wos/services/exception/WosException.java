package com.wos.services.exception;
...
public class WosException extends RuntimeException {
    ...
    public WosException(String message, Throwable e) {
        this(message, null, e);
    }

    public WosException(String message, String xmlMessage) {
        this(message, xmlMessage, null);
    }

    public WosException(String message, String xmlMessage, Throwable cause) {
        super(message, cause);
        if (xmlMessage != null) {
    ...
    /**
     * Obtain the error code returned by the WOS server.
     * 
     * @return Error code
     */
    ...
    /**
     * Obtain the error details returned by the WOS server.
     * 
    ...
    /**
     * Obtain the request ID returned by the WOS server.
     * 
     * @return Request ID
     */
    ...
    /**
     * Obtain the response headers of the HTTP request returned by the WOS
     * server.
     * 
    ...
    /**
     * Obtain the HTTP status code returned by the WOS server.
     * 
    ...
    /**
     * Obtain the HTTP response description returned by the WOS server.
     * 
    ...
    /**
     * Obtain the detailed error indicators returned by the WOS server.
     *
     * @return WOS Detailed error indicators returned by the server
     */
