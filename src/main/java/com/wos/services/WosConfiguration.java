 ...
 */
public class WosConfiguration implements Cloneable {
     ...
     * Constructor
     */
    public WosConfiguration() {
        this.connectionTimeout = WosConstraint.HTTP_CONNECT_TIMEOUT_VALUE;
        this.maxConnections = WosConstraint.HTTP_MAX_CONNECT_VALUE;
        this.maxErrorRetry = WosConstraint.HTTP_RETRY_MAX_VALUE;
        this.socketTimeout = WosConstraint.HTTP_SOCKET_TIMEOUT_VALUE;
        this.endpointHttpPort = WosConstraint.HTTP_PORT_VALUE;
        ...
        this.idleConnectionTime = WosConstraint.DEFAULT_IDLE_CONNECTION_TIME;
        this.maxIdleConnections = WosConstraint.DEFAULT_MAX_IDLE_CONNECTIONS;
        this.authType = AuthTypeEnum.V4;
        this.keepAlive = true;
        this.signatString = "";
    ...
    /**
     * Check whether path-style access to WOS is enabled. "true" indicates that
     ...
     *
     * @return Whether to enable path-style access to WOS.
     */
    ...
    /**
     * Specify whether to enable path-style access to WOS. "true" indicates that
    ...
    /**
     * Obtain the endpoint for accessing WOS.
     *
     * @return WOS endpoint
     */
    ...
    /**
     * Check whether HTTPS is used to connect WOS ("true" by default).
     *
     * @return Identifier specifying whether to use HTTPS to connect WOS
     */
