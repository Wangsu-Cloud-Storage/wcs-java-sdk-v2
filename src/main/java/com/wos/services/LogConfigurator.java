...
public class LogConfigurator {
    ...
    private static final Logger logger = Logger.getLogger("com.wos");

    private static final Logger ACCESS_LOG = Logger.getLogger("com.wos.log.AccessLogger");
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    m.invoke(null, "WOS Android SDK", "Enable SDK log failed", e);
                } catch (NoSuchMethodException | SecurityException ex) {
                    Method m = c.getMethod("i", String.class, String.class);
                    m.invoke(null, "WOS Android SDK", "Enable SDK log failed" + e.getMessage());
                }
            } catch (ClassNotFoundException | NoSuchMethodException | InvocationTargetException
    ...
    public synchronized static void enableAccessLog() {
        ...
        logOn(ACCESS_LOG, "/WOS-SDK-access.log");
    }
