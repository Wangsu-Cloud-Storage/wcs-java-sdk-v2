...
/**
 * WOS系统中的用到的常量。通过常量名称获取配置信息
 */
public class WosConstraint {
    /**
     * WOS域名的名称
     */
    public static final String END_POINT = "wos-endpoint";

    /**
     * 是否使用OPEN SSL(HTTPS)
     */
    public static final String HTTPS_ONLY = "wos.https-only";

    /**
     * 是否不把请求中的桶名加入域名
     */
    public static final String DISABLE_DNS_BUCKET = "wos.disable-dns-buckets";

    /**
     * 若使用HTTP，使用的端口号
     */
    public static final String HTTP_PORT = "wos-endpoint-http-port";

    /**
     * 若使用HTTPS，使用的端口号
     */
    public static final String HTTPS_PORT = "wos-endpoint-https-port";
    ...
    public static final String VERIFY_RESPONSE_CONTENT_TYPE = "wos.verify-content-type";
    ...
    /**
     * Environment variable name for the wos accesskey
     */
    public static final String ACCESS_KEY_ENV_VAR = "WOS_ACCESS_KEY_ID";

    /**
     * Environment variable name for the oss secretKey
     */
    public static final String SECRET_KEY_ENV_VAR = "WOS_SECRET_ACCESS_KEY";

    /**
     * Environment variable name for the securityToken
     */
    public static final String SECURITY_TOKEN_ENV_VAR = "WOS_SECURITY_TOKEN";
